 ...
 */
export const StockSuppliesHubView: React.FC<StockSuppliesHubViewProps> = ({ initialTab = 'estoque' }) => {
  const [activeTab, setActiveTab] = useState<StockSuppliesTab>(initialTab);
